    ...
    return (
        <div>
            ...
            <nav class="TabNavigationContainer">
                ...
                <a href="/about" class="TabNavigationLink"><i class="icon fas fa-users"></i> About us</a>


                <a href="/contact" class="TabNavigationLink"><i class="icon fas fa-user"></i>Contact</a>
            </nav>
            <br />
            <br />
            <br />
